...
-- Link: https://www.codewars.com/kata/5a8f00745084d718940000c5

-- You are the owner of the Grocery Store. All your products are in the
-- database, that you have created after CodeWars SQL exercises! :)

-- Customer often need to now how much really they pay for the products.
-- Manufacturers make different sizes of same product so it is hard to compare
-- prices, sometimes they make packages look big, but the weight of the product
-- is small.
...
SELECT 
  ...
  products.weight,
  products.price,
  ROUND((products.price / (products.weight / 1000))::numeric,2)::float as price_per_kg 
FROM products
