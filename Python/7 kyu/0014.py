...
# Complete the function that accepts two sequences as inputs and returns true if
# the vectors are orthogonal, and false if they are not. The sequences will
