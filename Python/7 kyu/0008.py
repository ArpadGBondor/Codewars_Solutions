# Kata: Change two-dimensional array
# Link: https://www.codewars.com/kata/581214d54624a8232100005f

# Function receive a two-dimensional square array of random integers. On the
# main diagonal, all the negative integers must be changed to 0, while the
