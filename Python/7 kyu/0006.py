# Kata: Is Sator Square?
# Link: https://www.codewars.com/kata/5cb7baa989b1c50014a53333

# A Discovery
# One fine day while Farmer Arepo Tenaciously Labored at Turning the soil, he
# discovered a field that was scattered with strange stone tablets. Noticing
# they were carved with letters in a square pattern, he wisely kept them in case
# some might be special.

# Your Task
# Please help Farmer Arepo by inspecting each tablet to see if it forms a valid
# Sator Square!

# The Square
# is a two-dimentional palindrome, made from words of equal length that can be
# read in these four ways:
...
def is_sator_square(tablet):
    for i in range(len(tablet)):
        reverse = list(tablet[i])[::-1]
        if reverse not in tablet:
            return False
