...
# Link: https://www.codewars.com/kata/550527b108b86f700000073f
...
# calculation using the Leibniz series and the Math::PI constant of your
# language is less than epsilon.

# Your function returns an array or a string or a tuple depending on the
...
# for PI at the end of 1000 iterations : since you are within epsilon of
# Math::PI you return
...
def iter_pi(epsilon):
    ...
    approximation = 4
    while abs(pi - approximation) > epsilon:
        number_of_iteration += 1
        approximation += (
            (-1 if number_of_iteration % 2 == 0 else 1)
            * 4
            / (2 * number_of_iteration - 1)
        )
    return [number_of_iteration, round(approximation, 10)]
