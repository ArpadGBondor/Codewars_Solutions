...
# is divisible by a fixed divisor without performing the division, usually by
...
# Multiply
# - the right most digit of the number with the left most number in the sequence
#   shown above,
# - the second right most digit with the second left most digit of the number in
#   the sequence.
...
# From now on the sequence is stationary (we always get 87) and the remainder of
# 1234567 by 13 is the same as the remainder of 87 by 13 ( i.e 9).

# Task:
# Write a function which processes this sequence of operations on an integer n
# (>=0) and returns the stationary number.
