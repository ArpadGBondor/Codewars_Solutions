# Kata: Buying a car
# Link: https://www.codewars.com/kata/554a44516729e4d80b000012
...
#   parameter (positive int or float, guaranteed) start_price_old (Old car
#   price)
#   parameter (positive int or float, guaranteed) start_price_new (New car
#   price)
...
def nb_months(
    ...
    month = 0
    savings = 0
    price_old = start_price_old
    price_new = start_price_new
    percent_loss = percent_loss_by_month
    ...
    while savings + price_old < price_new:
        ...
        if month % 2 == 0:
            percent_loss += 0.5
        price_old *= (100 - percent_loss) / 100
        price_new *= (100 - percent_loss) / 100
