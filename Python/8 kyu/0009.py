...
# The Task
# Think of a way to store the languages as a database. The languages are listed
# below so you can copy and paste!
...
def greet(language):
    ...
    if language in greetings_translations:
        return greetings_translations[language]
    return greetings_translations["english"]
