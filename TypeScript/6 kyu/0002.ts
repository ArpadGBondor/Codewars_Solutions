...
// Link: https://www.codewars.com/kata/56dbe7f113c2f63570000b86
...
// interspersed with dots proportional to the length of the segments, to better
// illustrate the rotation when printed.
// s = "abcd\nefgh\nijkl\nmnop" -->
// "abcd....\nefgh....\nijkl....\nmnop....\n....ponm\n....lkji\n....hgfe\n....dcba"
...
// Notice that the number of dots is the common length of "abcd", "efgh",
// "ijkl", "mnop".
...
export function selfieAndRot(s: string): string {
  return [
    ...s.split('\n').map((word) => word.padEnd(word.length * 2, '.')),
    ...rot(s)
      .split('\n')
      .map((word) => word.padStart(word.length * 2, '.')),
  ].join('\n');
}
