...
// stairs = [sunday,monday,tuesday,wednesday,thursday,friday,saturday] Make sure
// your solution takes into account all of the nesting within the stairs array.
...
// 6309, 7825] Your function should return the 20 year estimate of the stairs
...
export function stairsIn20(stairs: number[][]) {
  return (
    20 *
    stairs
      .map((day) => day.reduce((sum, n) => sum + n, 0))
